<template>
  <div class="flex h-full min-h-0 flex-col">
    ...
    <div
      ref="listScrollRef"
      class="min-h-0 flex-1 overflow-y-auto scrollbar-stable space-y-2"
    >
      <slot 
        name="content"
        :emails="emails"
      ...
      <!-- 空状态 -->
      <div v-if="emails.length === 0" class="flex h-full items-center justify-center p-8 text-center text-gray-400">
        <div class="w-full -translate-y-[25px]">
          <slot name="empty">
